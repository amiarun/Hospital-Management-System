...
{
    $examid=$_POST['hidden'];
    $sql_delete="delete from exam where exam_id='$examid'";
...
if(isset($_POST['register'])||isset($_POST['update']))
{
    ...
    {
        $f=1;
        $startdate_err="Enter A Valid Date Range!";
    }
    if ($startdate>=$enddate)
    {
        $f=1;
        $enddate_err="Enter A Valid Date Range!";
    }
    ...
    if($f==0)
    {
        ...
        {
            $sql_insert="update exam set exam_name='$examname',start_date='$startdate',end_date='$enddate' where exam_id='$examid' ";
        }

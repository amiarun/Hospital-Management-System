...
if($edate==" ")
{
    ...
    {
        $f=1;
        $sess_err="You Cannot Leave this Field Empty!";
    }
    if($f==0)
    {
        ...
        // $_SESSION['ename']=$examname;
        header('location:allocation3.php');
                                        ...
                                        <form method="post" enctype="multipart/form-data" class="form-horizontal">                        
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Dates </label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                <select name="edate" id="edate" class="form-control">
                                                    <option value=" ">-- Select Date --</option>
                                                    <?php
                                                        while($tt=$result_tt->fetch_assoc())
                                                        {   
                                                            // $sess=$tt['session'];
                                                            $date=$tt['exam_date'];
                                                    ?>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <select name="sess" id="sess" class="form-control">
                                                    <option value=" ">-- Select A Seesion --</option>

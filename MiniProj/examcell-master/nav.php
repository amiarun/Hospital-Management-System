                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="examhallreg.php">
                                <i class="fas fa-table"></i>Hall Registration</a>
                        </li>
                        <li>
                            <a href="examreg.php">
                                <i class="fas fa-table"></i>Exam Registration</a>
                        </li>
                        <li>
                            <a href="timetableview.php">
                                <i class="far fa-check-square"></i>Time Table View</a>
                        </li>
                        <li>
                            <a href="userreg.php">
                        ...
                        <li>
                            <a href="allocation.php">
                                <i class="far fa-check-square"></i>Exam Hall Allocation</a>
                        </li>
                        </ul>
                </div>
            </nav>
            ...
            <div class="menu-sidebar__content js-scrollbar1 ps">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="nav_item" data-id="time">
                            <a href="timetableview.php">
                                <i class="far fa-check-square"></i>Time Table View</a>
                        </li>
                        <li class="nav_item" data-id="user">
                            <a href="userreg.php">
                                <i class="far fa-check-square"></i>User Management</a>
                        </li>
                        <li class="nav_item" data-id="time">

...
if(isset($_POST['register'])||isset($_POST['update']))
{
    ...
    $sql_find="select * from examhall where room_no='$roomno' order by start_date";
    $result_find=$conn->query( $sql_find);
    $row_count_find= $result_find->num_rows;
    if($row_count_find == 1)
    {
        $f=1;
       echo"<script>alert('Registeration Failed. Record with Same Room Number Exist!');</script>";
    }
    if($f==0)
    {
        if($_POST['register'])
                                    ...
                                    <div class="card-body card-block">
                                        <form method="post" enctype="multipart/form-data" class="form-horizontal">                        
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="floor" name="floor" placeholder="Enter Floor Number (0, 1, 2, ..)" min="0" max="8" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="benches" name="benches" placeholder="Enter Here" class="form-control" min="1" max="100">

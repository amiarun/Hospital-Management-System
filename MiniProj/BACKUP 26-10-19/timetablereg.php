...
if(isset($_POST['register']))
{
    ...
    {
        $f=1;
        $examno_err="You Cannot Leave this Field Empty!";
    }
    if($f==0)
    {
        session_start();
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form method="post" enctype="multipart/form-data" class="form-horizontal">                        
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Number of Exams</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="examno" name="examno" placeholder="Enter Number of Exams" class="form-control">
                                                    <span id="examno_err"></span>
                                                    <?php echo(isset($examno_err))?$examno_err:""?>
                                                </div>
                                            </div>  
                                    </div>
